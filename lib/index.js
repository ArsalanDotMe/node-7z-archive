...
const { Files, ReplaceNativeSeparator, Run } = require('./utility.js');

const { createSfx } = require('./createSfx.js');
const { isWindows } = require('node-sys');
 ...
 */
const createArchive = SevenZip.createArchive = SevenZip.add = function (filepath, files, options, override = false) {
 ...
 * @returns {Promise} Promise
 */
const deleteArchive = SevenZip.deleteArchive = SevenZip.delete = function (filepath, files, options, override = false) {
 ...
 * @returns {Promise} Promise
 */
const extractArchive = SevenZip.extractArchive = SevenZip.extract = function (filepath, dest = '*', options = {}, override = false) {
  return when.promise(function (resolve, reject, progress) {
    /**
     * When a stdout is emitted, parse each line and search for a pattern.When
     * the pattern is found, extract the file (or directory) name from it and
 ...
 * @returns {Promise} Promise
 */
const fullArchive = SevenZip.fullArchive = SevenZip.extractFull = function (filepath, dest = '*', options = {}, override = false) {
  return when.promise(function (resolve, reject, progress) {
    /**
     * When a stdout is emitted, parse each line and search for a pattern.When
     * the pattern is found, extract the file (or directory) name from it and
 ...
 * @returns {Promise} Promise
 */
const listArchive = SevenZip.listArchive = SevenZip.list = function (filepath, options, override = false) {
  return when.promise(function (resolve, reject, progress) {
    let spec = {};
    /* jshint maxlen: 130 */
 ...
 * @returns {Promise} Promise
 */
const onlyArchive = SevenZip.onlyArchive = SevenZip.only = function (filepath, dest, files, options = {}, override = false) {
  return when.promise(function (resolve, reject, progress) {
 ...
 * @returns {Promise} Promise
 */
const renameArchive = SevenZip.renameArchive = SevenZip.rename = function (filepath, files, options, override = false) {
  return when.promise(function (resolve, reject, progress) {
    /**
     * When a stdout is emitted, parse each line and search for a pattern.When
     * the pattern is found, extract the file (or directory) name from it and
 ...
 * @returns {Promise} Promise
 */
const testArchive = SevenZip.testArchive = SevenZip.test = function (filepath, options, override = false) {
  return when.promise(function (resolve, reject, progress) {
    /**
     * When a stdout is emitted, parse each line and search for a pattern.When
     * the pattern is found, extract the file (or directory) name from it and
 ...
 * @returns {Promise} Promise
 */
const updateArchive = SevenZip.updateArchive = SevenZip.update = function (filepath, files, options, override = false) {
  return when.promise(function (resolve, reject, progress) {
    /**
     * When a stdout is emitted, parse each line and search for a pattern.When
     * the pattern is found, extract the file (or directory) name from it and
 ...
 * @returns {Promise} Promise
 */
const createSfxWindows = SevenZip.windowsSfx = function (name, files, destination, options, type) {
 ...
 * @returns {Promise} Promise
 */
const createSfxLinux = SevenZip.linuxSfx = function (name, files, destination, options) {
 ...
 * @returns {Promise} Promise
 */
const createSfxMac = SevenZip.macSfx = function (name, files, destination, options) {
